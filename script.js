...
window.onload = function () {
  ...
  container.style.transition = 'opacity 3s ease-out'; // Fade-out transition
  ...
  // Stop the confetti animation after 5 seconds and start fading out
  setTimeout(function () {
    if (frame) {
    ...
    // Remove the container after the fade-out transition completes
    setTimeout(function () {
      document.body.removeChild(container);
